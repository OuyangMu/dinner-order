...
const topOrderedDishes = computed(() => dishes.value
...
/** @type {__VLS_StyleScopedClasses['top-dish-meta']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dish-meta']} */ ;
/** @type {__VLS_StyleScopedClasses['qr-panel']} */ ;
...
if (!__VLS_ctx.isAuthed) {
    ...
    if (__VLS_ctx.activeTab === 'dashboard') {
        ...
        __VLS_asFunctionalElement(__VLS_intrinsicElements.article, __VLS_intrinsicElements.article)({
            ...{ class: "tool-section top-dishes-panel" },
        });
        __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
            ...{ class: "band-title" },
        });
        const __VLS_116 = {}.ChefHat;
        /** @type {[typeof __VLS_components.ChefHat, ]} */ ;
        // @ts-ignore
        ...
        if (__VLS_ctx.topOrderedDishes.length) {
            __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                ...{ class: "top-dishes-list" },
            });
            for (const [dish, index] of __VLS_getVForSourceType((__VLS_ctx.topOrderedDishes))) {
                __VLS_asFunctionalElement(__VLS_intrinsicElements.div, __VLS_intrinsicElements.div)({
                    key: (dish.id),
                    ...{ class: "top-dish-item" },
                });
    ...
    var __VLS_491;
    {
        const { footer: __VLS_thisSlot } = __VLS_487.slots;
...
/** @type {__VLS_StyleScopedClasses['metric']} */ ;
/** @type {__VLS_StyleScopedClasses['tool-section']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dishes-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['band-title']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dishes-list']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dish-item']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dish-rank']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dish-meta']} */ ;
/** @type {__VLS_StyleScopedClasses['top-dish-count']} */ ;
/** @type {__VLS_StyleScopedClasses['muted']} */ ;
/** @type {__VLS_StyleScopedClasses['qr-panel']} */ ;
/** @type {__VLS_StyleScopedClasses['band-title']} */ ;
/** @type {__VLS_StyleScopedClasses['muted']} */ ;
